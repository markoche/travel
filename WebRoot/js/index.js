...
var provinceList = [  
    ...
    function chooseCity(tag){
        ...
        var place = document.getElementById('act_city');
        var province = document.getElementById('province');
        var city = document.getElementById('city');
        var area = document.getElementById('area');
        function aa() {
            place.value = "";
            var prValue = provinceList[`${province.value}`];
            var ciValue = prValue.cityList[`${city.value}`];
            var arValue = ciValue.areaList[`${area.value}`];
            place.value = prValue.name+ciValue.name+arValue;
        }
